let taxiFareApiUrl = 'https://taxi-fare-model-hmgmzrqqbq-ew.a.run.app/predict'; // replace with your API endpoint
...
if (window.location.href.includes('https://taxifare.lewagon.com')) {
  taxiFareApiUrl = 'https://taxi-fare-model-hmgmzrqqbq-ew.a.run.app/predict';
}
